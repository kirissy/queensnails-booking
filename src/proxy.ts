...
/**
 * Refreshes the admin's Supabase session cookie on every request and gates
 * /admin/* behind login. Named `proxy` (not `middleware`) — Next.js 16 renamed
 * the convention; see AGENTS.md.
 */
